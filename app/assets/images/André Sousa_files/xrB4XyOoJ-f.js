...
isNativeFunction(w.chrome.csi)&&!!w.chrome.webstore&&
...
__d("MoatNHTDetection",["Banzai","MoatNHTFacebookSpecificSignals","MoatNHTSignals","URI"],(function(a,b,c,d,e,f){__p&&__p();var g=(b("MoatNHTSignals").getSignals()||[]).concat(b("MoatNHTFacebookSpecificSignals").getSignals()||[]),h=0,i=function(){var a={};g.forEach(function(b){a[b.getName()]=b.evaluate()});return a};a={evaluateAndLogSignals:function(a){var c=i();a={token:a,results:c};b("Banzai").post("xtrackable:moat_nht",a);h&&!1}};e.exports=a}),null);